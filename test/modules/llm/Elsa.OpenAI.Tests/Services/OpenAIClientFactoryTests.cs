...
public class OpenAIClientFactoryTests
{
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void GetClient_WithNullOrWhitespaceApiKey_ThrowsArgumentException(string? apiKey)
    {
        // Arrange
        var factory = new OpenAIClientFactory();

        // Act & Assert
        Assert.ThrowsAny<ArgumentException>(() => factory.GetClient(apiKey!));
    }
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void GetChatClient_WithNullOrWhitespaceModel_ThrowsArgumentException(string? model)
    {
        // Arrange
        var factory = new OpenAIClientFactory();

        // Act & Assert
        Assert.ThrowsAny<ArgumentException>(() => factory.GetChatClient(model!, "test-api-key"));
    }
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void GetImageClient_WithNullOrWhitespaceModel_ThrowsArgumentException(string? model)
    {
        // Arrange
        var factory = new OpenAIClientFactory();

        // Act & Assert
        Assert.ThrowsAny<ArgumentException>(() => factory.GetImageClient(model!, "test-api-key"));
    }
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void GetAudioClient_WithNullOrWhitespaceModel_ThrowsArgumentException(string? model)
    {
        // Arrange
        var factory = new OpenAIClientFactory();

        // Act & Assert
        Assert.ThrowsAny<ArgumentException>(() => factory.GetAudioClient(model!, "test-api-key"));
    }
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void GetEmbeddingClient_WithNullOrWhitespaceModel_ThrowsArgumentException(string? model)
    {
        // Arrange
        var factory = new OpenAIClientFactory();

        // Act & Assert
        Assert.ThrowsAny<ArgumentException>(() => factory.GetEmbeddingClient(model!, "test-api-key"));
    }
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void GetModerationClient_WithNullOrWhitespaceModel_ThrowsArgumentException(string? model)
    {
        // Arrange
        var factory = new OpenAIClientFactory();

        // Act & Assert
        Assert.ThrowsAny<ArgumentException>(() => factory.GetModerationClient(model!, "test-api-key"));
    }

...
| Status | Extension | Description | Module Name | Issue |
|--------|------------|-------------|-------------|-------|
| [✅](https://github.com/elsa-workflows/elsa-extensions/tree/main/src/modules/devops/Elsa.DevOps.AzureDevOps/README.md) | **Azure DevOps** | Repositories, pull requests, work items, builds | `Elsa.DevOps.AzureDevOps` | [Fixed Issue](https://github.com/elsa-workflows/elsa-extensions/issues/124) |

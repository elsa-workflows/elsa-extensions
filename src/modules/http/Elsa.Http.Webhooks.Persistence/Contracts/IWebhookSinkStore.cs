...
namespace Elsa.Http.Webhooks.Persistence.Contracts;

public interface IWebhookSinkStore
{
    ...
    Task<bool> SoftDeleteAsync(string id, string? expectedVersion = null, CancellationToken cancellationToken = default);

...
public class CreatePullRequest : AzureDevOpsActivity
{
    ...
    protected override ValueTask<bool> CanExecuteAsync(ActivityExecutionContext context)
    {
        ...
        ActivityInputValidation.ThrowIfInvalid(context, ActivityInputValidation.TryValidateRequired(sourceBranch, nameof(SourceBranch)));
        ActivityInputValidation.ThrowIfInvalid(context, ActivityInputValidation.TryValidateRequired(targetBranch, nameof(TargetBranch)));

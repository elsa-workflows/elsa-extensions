...
**Exit Criteria**: Developers can generate migrations in either mode using documented commands only.
...
3. Update module/package READMEs for registration, DbContext composition, and migration generation.
